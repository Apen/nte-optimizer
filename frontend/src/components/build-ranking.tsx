...
import type { EquipmentScoreContribution, Result } from '../types'
...
export function BuildRankingTable({ builds, active, onSelect }: { builds: Result[]; active: number; onSelect: (rank: number) => void }) {
  ...
  const columns = ['BasicDamageIndex', 'AtkFinal', 'CritBase', 'CritDamageBase', 'MagBase', 'DamageUpGeneralBase', 'DamageUpIncantationBase']
